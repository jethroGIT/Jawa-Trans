...
import logo from '../assets/CL/banner-footer.png';

export default function Footer() {
    return (
        <footer className="bg-gray-50 pt-16 pb-8 border-t-2 border-gray-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    {/* Contact Info */}
                    <div>
                        <h3 className="text-lg font-semibold text-blue-600 mb-3">Kontak</h3>
                        <div className="space-y-3">
                            <div>
                                <p className="text-gray-600 text-sm">Whatsapp:</p>
                                <a href="https://wa.me/6281222232452" className="text-gray-700 hover:text-blue-600">
                                    +68 212-223-2452
                                </a>
                            </div>
                            <div>
                                <p className="text-gray-600 text-sm">Email:</p>
                                <a href="mailto:info@jawatrans.co.id" className="text-gray-700 hover:text-blue-600">
                                    info@jawatrans.co.id
                                </a>
                            </div>
                            <div>
                                <p className="text-gray-600 text-sm">Alamat:</p>
                                <p className="text-gray-700">
                                    Jl. Dr. Djunjunan No.77, Pajajaran, Kec. Cicendo, Kota Bandung, Jawa Barat 40161
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Social Media */}
                    <div>
                        <h3 className="text-lg font-semibold text-blue-600 mb-3">Sosial Media</h3>
                        ...
                        <p className="text-gray-600 text-sm">
                            Kami hadir untuk memberikan layanan terbaik di setiap perjalanan Anda — dari pemesanan mudah hingga sampai tujuan dengan penuh kepastian.
                        </p>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-300 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-600 text-sm">
                            © 2025 jawatrans. All rights reserved.
                        </p>
                        ...
                        <p className="text-gray-500 text-sm">
                            Powered By Jethro Pria Tampan Stok Terakhir
                        </p>
                    </div>
                </div>
            </div>
